function demo_tfd_semisup(numhid_id, numhid_var, numhid, numvar, numid, l2reg,...
...
params = struct('numvis', numvis, 'numhid_id', numhid_id, 'numhid_var', numhid_var, ...
	            'l2reg', l2reg, 'epsilon', epsilon, 'dataset', 'tfd', 'maxiter', maxiter, ...
...
[ weights, params ] = train_var_semisup(Xtrain, Ytrain, params);
